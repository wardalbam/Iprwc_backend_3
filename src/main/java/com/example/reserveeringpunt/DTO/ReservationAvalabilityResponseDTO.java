...
public class ReservationAvalabilityResponseDTO {
    ...
    // openingTime and closingTime are strings because they are sent to the frontend
    // as strings
    private LocalTime openingTime;
    private LocalTime closingTime;
    // availableTimeSlots is a list of strings because they are sent to the frontend
    // as strings
