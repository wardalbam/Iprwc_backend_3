...
import com.example.reserveeringpunt.DAO.RoleRepo;
import com.example.reserveeringpunt.DAO.RoomRepository;
import com.example.reserveeringpunt.DAO.RoomTypeRepository;
import com.example.reserveeringpunt.DAO.UserRepo;
import com.example.reserveeringpunt.DTO.CreateBulkReservationsRequestDTO;
import com.example.reserveeringpunt.DTO.CreateReservationRequestDTO;
import com.example.reserveeringpunt.DTO.CreateReservationResponseDTO;
import com.example.reserveeringpunt.DTO.TimeSlotDTO;
import com.example.reserveeringpunt.DTO.TimeSlotStringDTO;
...
import com.example.reserveeringpunt.Service.ReservationService;
...
public class ReservationController {
    ...
    public ResponseEntity<?> deleteReservationByIdUser(@PathVariable Long id, HttpServletRequest request) {
        ...
        if (user.getRoles().contains(roleRepo.findByName("ROLE_USER"))
            ...
            // if reservation belongs to the user
            if (reservationRepository.findById(id).get().getUser().getId() == user.getId()) {
                try {
