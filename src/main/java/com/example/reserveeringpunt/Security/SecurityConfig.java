package com.example.reserveeringpunt.Security;

import com.example.reserveeringpunt.Filter.CustomAuthentivationFilter;
import com.example.reserveeringpunt.Filter.CustomAuthorizationFilter;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
        ...
        protected void configure(HttpSecurity http) throws Exception {
                ...
                http.authorizeRequests().antMatchers(POST, "/api/rooms/create").hasAnyAuthority("ROLE_ADMIN",
                                "ROLE_MANAGER");
                ...
                http.authorizeRequests().antMatchers(DELETE, "/api/reservations/delete/**").hasAnyAuthority(
                                "ROLE_ADMIN",
                                "ROLE_MANAGER");
